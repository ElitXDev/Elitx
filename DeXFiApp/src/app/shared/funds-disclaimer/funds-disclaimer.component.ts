...
export class FundsDisclaimerComponent {
  visible = true;
  text =
    'This is an early beta release on the Hooks testnet. EXPECT DRAGONS AND DO NOT MAKE REAL TRANSACTIONS TO ANY OF THE ADDRESSES SHOWN! Only use the one-click sending method.';
  eleAnimation = '';
